...
#         try:
#             dl_1d = await count_downloads_since(session, 1)
#             dl_7d = await count_downloads_since(session, 7)
#             dl_30d = await count_downloads_since(session, 30)
#         except:
#             dl_1d = dl_7d = dl_30d = 0
